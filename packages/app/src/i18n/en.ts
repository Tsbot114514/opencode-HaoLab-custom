export const dict = {
  ...
  "markdownEditor.fileType": "Select a .md or .markdown file.",
  "markdownEditor.unsavedDraft": "Save or reload the current draft first.",
  "markdownEditor.unsavedChanges": "Unsaved changes",
  "markdownEditor.loadFailed": "Failed to load Markdown editor",
  "markdownEditor.conflict":
    "The file on disk differs from this draft. Save this draft as your version, or reload the file from disk.",
  "markdownEditor.keepMine": "Save my version",
  "markdownEditor.reload": "Reload",
  "markdownEditor.empty": "Open a Markdown file to start editing.",
  "markdownEditor.review.mode": "Review mode",
  "markdownEditor.review.summary": "+{{additions}} / -{{deletions}} proposed lines",
  "markdownEditor.review.save": "Save review",
  "markdownEditor.review.saved": "Review saved to file",
  "markdownEditor.review.discard": "Discard",
  "markdownEditor.review.nextRevision": "Next revision",
  "markdownEditor.review.nextComment": "Next comment",
  "markdownEditor.review.addComment": "Add comment",
  "markdownEditor.review.restoreDeletion": "Undo deletion",
  "markdownEditor.review.commentPlaceholder": "Write a comment...",
  "markdownEditor.review.deleted": "Deleted",
  "markdownEditor.review.autoSaving": "Auto-saving...",
  "markdownEditor.review.autoSavePending": "Auto-save pending",
