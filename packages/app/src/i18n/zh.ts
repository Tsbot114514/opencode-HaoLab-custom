...
export const dict = {
  "markdownEditor.fileType": "请选择 .md 或 .markdown 文件。",
  "markdownEditor.unsavedDraft": "请先保存或重新加载当前草稿。",
  "markdownEditor.unsavedChanges": "未保存的更改",
  "markdownEditor.loadFailed": "Markdown 编辑器加载失败",
  "markdownEditor.conflict": "磁盘文件与当前草稿不同。可保存当前草稿作为你的版本，或重新加载磁盘文件。",
  "markdownEditor.keepMine": "保存我的版本",
  "markdownEditor.reload": "重新加载",
  "markdownEditor.empty": "打开 Markdown 文件以开始编辑。",
  "markdownEditor.review.mode": "审阅模式",
  "markdownEditor.review.summary": "建议新增 {{additions}} 行、删除 {{deletions}} 行",
  "markdownEditor.review.save": "保存审阅",
  "markdownEditor.review.saved": "审阅已保存到文件",
  "markdownEditor.review.discard": "放弃修订",
  "markdownEditor.review.nextRevision": "下一处修订",
  "markdownEditor.review.nextComment": "下一处批注",
  "markdownEditor.review.addComment": "添加批注",
  "markdownEditor.review.restoreDeletion": "撤销删除",
  "markdownEditor.review.commentPlaceholder": "填写批注内容…",
  "markdownEditor.review.deleted": "已删除",
  "markdownEditor.review.autoSaving": "正在自动保存…",
  "markdownEditor.review.autoSavePending": "等待自动保存",
