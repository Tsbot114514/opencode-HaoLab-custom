...
const api: ElectronAPI = {
  ...
  getHaolabDataLocation: () => ipcRenderer.invoke("get-haolab-data-location"),
  migrateHaolabData: (selectedDir) => ipcRenderer.invoke("migrate-haolab-data", selectedDir),
  deleteDefaultHaolabData: () => ipcRenderer.invoke("delete-default-haolab-data"),
